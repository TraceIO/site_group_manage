class PropertiesUtil(object):
    ...
    def get_config_dict(self, file_path="database.properties"):
        """
        获取资源文件，形成字典
...
if __name__ == "__main__":
    ...
    print(prop.get_config_dict("database.properties"))
    print(prop.get_config_value("database.properties", "dbtype"))
